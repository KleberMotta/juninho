...
function writeSkills(projectDir) {
    ...
    (0, fs_1.writeFileSync)(path_1.default.join(skillsDir, "test-writing", "SKILL.md"), TEST_WRITING);
    (0, fs_1.writeFileSync)(path_1.default.join(skillsDir, "page-creation", "SKILL.md"), PAGE_CREATION);
    (0, fs_1.writeFileSync)(path_1.default.join(skillsDir, "api-route-creation", "SKILL.md"), API_ROUTE_CREATION);
    (0, fs_1.writeFileSync)(path_1.default.join(skillsDir, "server-action-creation", "SKILL.md"), SERVER_ACTION_CREATION);
    (0, fs_1.writeFileSync)(path_1.default.join(skillsDir, "schema-migration", "SKILL.md"), SCHEMA_MIGRATION);
}
// ─── Test Writing ────────────────────────────────────────────────────────────
const TEST_WRITING = `---
name: test-writing
